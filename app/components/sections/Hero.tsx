...
const Hero: FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        PASSIONATE PROGRAMMER SOFTWARE FRONTEND BACKEND DEVELOPER
      </strong>
      ...
      <div className='image-animation z-10 select-none mt-0 xs:mt-6 sm:mt-14 lg:mt-0 px-0 mx-auto lg:p-0 lg:basis-1/3'>
        <div className='relative w-72 md:w-80 h-80 flex items-center mx-auto'>
          <div className='absolute pointer-events-none scale-90 xs:scale-95 mx-auto'>
            <Image
              src='/satnaing-illustration.webp'
              width={1177}
              height={1374}
              priority
      ...
      <div className='lg:basis-2/3 z-10 relative'>
        ...
        <div className='overflow-hidden'>
          <span className='text-animation text-2xl  lg:text-4xl block md:my-3 text-marrsgreen dark:text-carrigreen font-medium'>
            A Software Engineer
          </span>
        </div>
        <div className='mt-2 my-4 md:mb-8'>
          <p className='mb-1 lg:text-3xl [text-wrap:balance]'>
            I craft software for enjoyment and to make a positive impact on the
            world
          </p>
        </div>
